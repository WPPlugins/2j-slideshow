	...
	if(!function_exists('twoj_slideshow_showInformation')){
		function twoj_slideshow_showInformation(){
			...
			echo '<div id="twoj_showInformation" '
						.'style="display: none;" '
						.'data-open="1" '
						.'data-title="'.twoj_slideshow_t('Get 2J Slideshow Premium version', '2j-slideshow').'" '
						.'data-close="'.__('Close', '2j-slideshow').'" '
						.'data-info="'.twoj_slideshow_t('Get Premium version', '2j-slideshow').'"'
					.'>'
					.twoj_slideshow_t('You can create only 1 slideshow. Update to Premium to get unlimited slideshows', '2j-slideshow')
				.'</div>';
		}
