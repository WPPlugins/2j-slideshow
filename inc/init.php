...
twoj_slideshow_include( array('editor_button.php', 'widget.php') );
twoj_slideshow_include(array('duplicate.php'), TWOJ_SLIDESHOW_ADDONS_PATH);
    ...
    register_post_type( TWOJ_SLIDESHOW_TYPE_POST,
        array(
          'labels' => array(
            ...
            'add_new'       => twoj_slideshow_t( 'Add Slideshow', 	'2j-slideshow' ),
            'add_new_item'  => twoj_slideshow_t( 'Add Slideshow', 	'2j-slideshow' ),
            'edit_item'     => twoj_slideshow_t( 'Edit Slideshow', 	'2j-slideshow' ),
          ),
...
if( is_admin() ){
	...
	twoj_slideshow_include(  array('media_fields.php', 'menu.php' )  );
}
